defmodule CarbonCopCheckAppWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: CarbonCopCheckAppWeb.Gettext
  ...
  def modal(assigns) do
    ...
    >
      <div
        id={"#{@id}-bg"}
        class="bg-cc-brown/70 fixed inset-0 transition-opacity"
        aria-hidden="true"
      />
      <div
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(CarbonCopCheckAppWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(CarbonCopCheckAppWeb.Gettext, "errors", msg, opts)
    end
  end
